...
def scrape_website():
    ...
    which = input("Repair and Diagnosis or Parts and Labor: ")
    word2 = which.split()
    result2 = "%20".join(word2)
    url = f'https://charm.li/{make}/{year}/{result}/{result2}'
    print(url)
...
def save_to_sqlite(data):
    ...
    conn = sqlite3.connect('scraped_data5.db')
